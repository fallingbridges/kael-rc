...
import { GoalTiers, DifferenceBody, MechanismBody, PromiseBody, AllSetBody, GiftBody, OfferBody, SignupBody, DeclineBody, SavedBody } from './PrePaywall.jsx'
...
function Body(props) {
  switch (props.s.kind) {
    ...
    case 'gift': return <GiftBody onNext={props.onAdvance} />
